...
% Shade Discrimination Task with a modified colour/tone
...
% save the results
save('my_results_blue.mat', 'resp', 'trials_rnd', 'rf_contr', 'contrasts', 'n_reps')
...
% YOUR CURRENT SCRIPT)
load("/Users/tamarabgreco/Documents/MATLAB/psyc-353/my_results_blue.mat")
...
scatter(contr_diff, p_targ, 50, 'MarkerFaceColor', [0 .7 .7], 'MarkerEdgeColor', [0 .5 .5])
...
% plot
plot(x, pal_fit, 'LineWidth', 2, 'MarkerFaceColor', [0 .150 .255], 'DisplayName', 'Modified coloured task');
%legend('Original colour results','Modified colour results','Location','northwest', 'FontSize', 10)

hold off

%% display of the plot 
% the original trial plot was done in its original file, and this plot/data
% points were added after generating the original

legend('Original task data points','Original task Palamedes line', 'Modified task data points','Modified task Palamedes line','Location','northwest', 'FontSize', 10)

set(gca, 'FontSize', 10)
title('Palamedes Fits Original vs Modified Task')
savefig ('palamedes_compare_img')
