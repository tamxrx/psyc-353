...
if ~paramSupplied
    ...
    params = pfhb.model.parameters(find(~contains(pfhb.model.parameters,'_actual')));
    if pfhb.model.Nsubj > 1
        params = params(find(contains(params,'mu')));
    end
    ...
    if Neffects == 1
        ...
        xlabeltext = 'subject';
        effects = ones(1,length(subjectsList));
        ...
        if PAL_mmType(pfhb.model.(param(1)).c) == 1 || contains(param,'_actual')
