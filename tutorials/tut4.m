...
% save the results
save('my_results.mat', 'resp', 'trials_rnd', 'rf_contr', 'contrasts', 'n_reps')
...
scatter(contr_diff, p_targ, 100, 'MarkerFaceColor', [0 .7 .7], 'MarkerEdgeColor', [0 .5 .5])
